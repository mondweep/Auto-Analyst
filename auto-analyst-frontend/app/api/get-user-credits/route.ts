...
//     const credits = await redisAny.get(`user:${userId}:credits`)
//     const lastReset = await redisAny.get(`user:${userId}:last_reset`) || new Date().toISOString()
//     const usedCredits = await redisAny.get(`user:${userId}:used_credits`)
//
